...
tftdemo = {
	dispType = tft.ILI9341, -- or tft.ST7735B, tft.ST7735, tft.ST7735G
	maxx = 240,
	maxy = 320,
	miny = 12,
	touch = true,
	...
	images = {
		praw = {"newyear_128x96.img", 128, 96},
		lraw = {"nature_160x123.img", 160, 123},
...
function tftdemo.init()
	if tft.gettype() < 0 then
		tft.init(tftdemo.dispType, tft.PORTRAIT_FLIP)
		if tft.gettype() < 0 then
