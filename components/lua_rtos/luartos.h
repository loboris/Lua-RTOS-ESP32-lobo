...
#define LUA_USE_SENSORS CONFIG_LUA_RTOS_LUA_USE_SENSORS
#define LUA_USE_BME280 CONFIG_LUA_RTOS_LUA_USE_BME280
#define LUA_USE_OW CONFIG_LUA_RTOS_LUA_USE_OW
#define LUA_USE_LED CONFIG_LUA_RTOS_LUA_USE_LED
#define LUA_USE_SENSOR LUA_USE_SENSORS
...
#ifdef CONFIG_LUA_RTOS_SD_MODE_1BIT
#define SD_1BITMODE 1
#else
#define SD_1BITMODE 0
#endif

#ifdef CONFIG_LUA_RTOS_SD_FORMAT
#define SD_FORMAT 1
#else
#define SD_FORMAT 0
#endif

#if CONFIG_LUA_RTOS_SD_MAXFILES
#define SD_MAXFILES CONFIG_LUA_RTOS_SD_MAXFILES
#else
#define SD_MAXFILES 5
#endif
