...
// Sensor exfunc values
typedef enum {
	EXFUNC_DS1820_GETROM = 1,
	EXFUNC_DS1820_GETTYPE,
	EXFUNC_DS1820_GETRESOLUTION,
	EXFUNC_DS1820_NUMDEV,
	EXFUNC_OWIRE_LISTDEV,
	EXFUNC_BME280_GETMODE
} sensor_exfunc_t;
